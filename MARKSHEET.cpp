...
int roll_number, clss , hi_marks, eng_marks, san_marks, math_marks, sci_marks, so_sci_marks;
void generate_marksheet()
{
    ...
    printf("\n------------------------------------------------------------------------------------\n");
    printf("|                  MH BOARD HIGH SCHOOL CERTIFICATE EXAMINATION                     |\n");
    printf("|------------------------------------------------------------------------------------\n");
    printf("|Your name: %s\tclass: %dth\tRoll Number: %d\n", name, clss, roll_number);
